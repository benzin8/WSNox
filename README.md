...
- **[Файлы-вложения](docs/features/file-attachments.md)**: отправка любого файла (до 50 МБ) → карточка с цветным бейджем расширения, именем и размером, тап = скачать; `msg_type="file"`, хранение в S3 как есть
...
- [Файлы-вложения](docs/features/file-attachments.md) — любой файл (≤50 МБ), карточка с цветным бейджем расширения, `process_file`/`msg_type=file`
